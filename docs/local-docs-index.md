...
### Files most relevant to K3D printer config
...
To refresh: `cd ~/git/kalico && git pull`. Last checked 2026-05-20 at commit 29e8ef4.
...
- **`~/git/beacon_klipper/`** — the Klipper module (`beacon3d/beacon_klipper`)
  ...
  - `requirements.txt` — Python deps the module needs
